    ...
    <div class="p-4 mt-12 sm:ml-64">
        <div class="mt-4 p-4  relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <a href="kategori/tambah"
                class="mt-10 inline-block text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 shadow-lg shadow-green-500/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Tambahkan
                Kategori</a>
        </div>
            ...
            categories.forEach(category => {
                resultsDiv.append(`
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <a href="/kategori/edit/${category.id}" class="mr-5 font-medium text-yellow-400 hover:underline">Edit</a>
                            <form action="/kategori/delete/${category.id}" method="POST" onsubmit="confirmDelete(event)">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="mr-3 font-medium text-red-600 hover:underline">Hapus</button>
                            </form>
                        </td>
                    </tr>
                `);
