        ...
        <div class="mt-4 p-4 relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <caption
                    ...
                    KATEGORI SURAT
                    <h3 class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400"> Berikut ini adalah kategori yang
                        bisa
                        digunakan untuk melabeli surat.<h3>
                            <h3 class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400"> Klik "Tambah Kategori"
                                pada kolom aksi untuk menambahkan kategori baru.<h3>
                                    <p></p>
                </caption>
